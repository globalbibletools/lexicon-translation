...
import { WordTreeDataProvider, Entry } from "./wordTreeView.js";
// This method is called when your extension is activated
// Your extension is activated the very first time the command is executed
export function activate(context) {
    // Use the console to output diagnostic information (console.log) and errors (console.error)
    // This line of code will only be executed once when your extension is activated
    console.log('Congratulations, your extension "lexicon-translation" is now active!');
    // Initialize the data for the tree view
    Entry.initialize().then(() => {
        ...
        vscode.window.registerTreeDataProvider("treeView-word", wordTreeDataProvider);
    ...
    const disposable = vscode.commands.registerCommand("lexicon-translation.helloWorld", () => {
        // The code you place here will be executed every time your command is executed
        // Display a message box to the user
        vscode.window.showInformationMessage("Hello World from Lexicon Translation!");
    });
